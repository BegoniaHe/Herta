export const zh = {
  ...
  "voice.model": "语音模型",
  "voice.modelAbsent": "约 {size} MB，下载到本机后她才能出声。",
  ...
  "voice.engine": "语音引擎",
  "voice.engineDesc":
    "本地模型在本机合成；MiniMax 用你自己的密钥在云端克隆她的声音。",
  "voice.engine.local": "本地模型",
  "voice.engine.minimax": "MiniMax 云端",
  "voice.minimaxNote":
    "每句话都会发送到 MiniMax 合成，按字符计费到你的账户；声音闲置 7 天会被平台删除，届时自动重新克隆。",
  "voice.minimaxKey": "MiniMax API 密钥",
  "voice.minimaxKeyDesc": "加密保存在本机；在 MiniMax 开放平台获取。",
  ...
  "voice.clone": "克隆声音",
  "voice.cloneAbsent": "上传随附的参考录音，在你的账户里克隆她的声音。",
  "voice.clonePreparing": "正在上传并克隆…",
  "voice.cloneReady": "已就绪，克隆于 {date}。",
  "voice.clonePrepare": "准备",
  "voice.cloneRedo": "重新克隆",
  "voice.cloneRetry": "重试",
